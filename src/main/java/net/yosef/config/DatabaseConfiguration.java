...
@Configuration
@EnableJpaRepositories("net.yosef.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("net.yosef.repository.search")
public class DatabaseConfiguration implements EnvironmentAware {
    ...
    @ConditionalOnMissingClass(name = "net.yosef.config.HerokuDatabaseConfiguration")
